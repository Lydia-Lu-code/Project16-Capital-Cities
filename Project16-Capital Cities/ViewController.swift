...
class ViewController: UIViewController, MKMapViewDelegate {
    ...
    let london = Capital(title: "London", coordinate: CLLocationCoordinate2D(latitude: 51.507222, longitude: -0.1275), info: "Home to the 201 Summer Olympics")
    ...
    let rome = Capital(title: "Rome", coordinate: CLLocationCoordinate2D(latitude: 21.9, longitude: 12.5), info: "Has a whole country inside it.")
